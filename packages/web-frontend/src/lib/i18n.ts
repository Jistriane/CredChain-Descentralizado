...
export const translations: Record<Language, Translations> = {
  'pt-BR': {
    ...
    wallet: {
      ...
      network: 'Rede',
      chainId: 'Chain ID',
      metamaskRequired: 'Nenhuma carteira Polkadot encontrada. Por favor, instale Polkadot.js, Talisman, SubWallet ou Nova Wallet.',
      connectionRejected: 'Conexão rejeitada pelo usuário.',
      networkError: 'Erro ao conectar com a carteira. Certifique-se de estar na Polkadot Mainnet.',
      instructions: 'Instruções:',
      instruction1: '1. Instale uma carteira Polkadot (Polkadot.js, Talisman, SubWallet ou Nova Wallet)',
      instruction2: '2. Clique em "Conectar Carteira Polkadot"',
      instruction3: '3. Selecione sua carteira preferida',
      instruction4: '4. Aprove a conexão na sua carteira',
    },
    dashboard: {
      title: 'Dashboard',
      subtitle: 'Bem-vindo',
  ...
  'en': {
    ...
    wallet: {
      ...
      network: 'Network',
      chainId: 'Chain ID',
      metamaskRequired: 'No Polkadot wallet found. Please install Polkadot.js, Talisman, SubWallet or Nova Wallet.',
      connectionRejected: 'Connection rejected by user.',
      networkError: 'Error connecting to wallet. Make sure you are on Polkadot Mainnet.',
      instructions: 'Instructions:',
      instruction1: '1. Install a Polkadot wallet (Polkadot.js, Talisman, SubWallet or Nova Wallet)',
      instruction2: '2. Click "Connect Polkadot Wallet"',
      instruction3: '3. Select your preferred wallet',
      instruction4: '4. Approve the connection in your wallet',
    },
    dashboard: {
      title: 'Dashboard',
      subtitle: 'Welcome',
  ...
  'es': {
    ...
    wallet: {
      ...
      network: 'Red',
      chainId: 'Chain ID',
      metamaskRequired: 'No se encontró ninguna cartera Polkadot. Por favor, instale Polkadot.js, Talisman, SubWallet o Nova Wallet.',
      connectionRejected: 'Conexión rechazada por el usuario.',
      networkError: 'Error al conectar con la cartera. Asegúrese de estar en Polkadot Mainnet.',
      instructions: 'Instrucciones:',
      instruction1: '1. Instale una cartera Polkadot (Polkadot.js, Talisman, SubWallet o Nova Wallet)',
      instruction2: '2. Haga clic en "Conectar Cartera Polkadot"',
      instruction3: '3. Seleccione su cartera preferida',
      instruction4: '4. Apruebe la conexión en su cartera',
    },
    dashboard: {
      title: 'Panel',
      subtitle: 'Bienvenido',
